                    ...
                    <div className="modal-content" style={{ boxShadow: '3px 2px 2px 15px grey' }}>
                        ...
                        <div className="modal-body">
                            <form>
                                ...
                                <input type="checkbox" className="form-check-input me-2" id="Check"></input>
                                <label className="form-check-label" for="Check">Remember me</label><br></br>
                                <div class="row mt-2 ps-2 ">
                                    <button class="btn btn-outline-primary">Login</button>
                                    <div class="col-5 ms-auto pe-0 me-0"><span class="fa fa-question-circle me-1"></span>Forgot password</div>
                                </div>
                                <hr></hr>
                                ...
                                <div class="row text-center" >
                                    <div class="col" align="center">
                                         <p>Need an account <span><NavLink to='/SignUp' className="nav-link" style={{border:"1px solid black",width:"fit-content",marginTop:"10px",borderRadius:"10px"}}>Sign Up</NavLink></span></p>
                                    </div>    
                                </div>
                            </form>
                        </div>
